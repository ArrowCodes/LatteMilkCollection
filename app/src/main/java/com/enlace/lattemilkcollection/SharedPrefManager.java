...
public class SharedPrefManager {
    ...
    private final static String KEY_P_TYPE = "ptype";
    ...
    public boolean userLogin(String user_id, String fname, String lname, String email, String pnumber,String status)
    {
...
*/
    public String getKeyPType()
    {
        SharedPreferences sharedPreferences = mCtx.getSharedPreferences(SHARED_PREF_NAME, Context.MODE_PRIVATE);
        return sharedPreferences.getString(KEY_P_TYPE,null);
    }
